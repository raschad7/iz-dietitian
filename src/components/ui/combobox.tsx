...
function ComboboxContent({
  ...
  >) {
  /*
    Portalled into the dialog when inside one — a modal `<dialog>` sits in the
    browser's top layer and paints above anything portalled to `body`, so the
    list would be invisible and unclickable. See `useDialogContainer`.
  */
...
function ComboboxItem({
  ...
  return (
    ...
    >
      ...
      >
        <Icon name="check" className="pointer-events-none text-primary" />
      </ComboboxPrimitive.ItemIndicator>
    </ComboboxPrimitive.Item>
  )
}
    ...
    >
      ...
      {showRemove && (
        <ComboboxPrimitive.ChipRemove
          /* `icon-sm`: this project's Button has no `icon-xs` step. */
