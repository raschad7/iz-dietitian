...
/**
 * A pushed screen, not a tab: "see all" in `PortalNotificationsBell` opens
 * this and the client backs out of it, the same shape every screen under
 * `(screen)` takes.
 *
 ...
 *
 * `loadNotificationsPage` reads the exact loader the bell's own preview uses
 * (`loadPortalNotifications`), so the screen behind "see all" can never list a
 * row the popover did not already know about.
 */
