...
async function main(): Promise<void> {
  ...
  const outcome: GenerationOutcome = await runReviewedGeneration({
    input: {
      ...
      catalog: toPromptCatalog(catalog, context.profile.dietPattern, context.profile.allergenTags),
      sides: toPromptSides(catalog, context.profile.dietPattern, context.profile.allergenTags),
      instruction: null,
      previousSlugs: [],
      days: [...DAYS_OF_WEEK],
      scope: 'week',
